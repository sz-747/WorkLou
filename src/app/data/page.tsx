...
export default async function DataCheck() {
  ...
  return (
    <main>
      <h1>Data check — Phase 1 verification</h1>
      <p>
        {allServices.length} services, {attributes.length} service facts, {contexts.length} case
        context(s), {referralRows.length} referral(s).
      </p>
